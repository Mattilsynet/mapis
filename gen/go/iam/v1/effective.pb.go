...
func (m *UserPermissionSpec) CloneVT() *UserPermissionSpec {
	...
	if rhs := m.Permissions; rhs != nil {
		r.Permissions = make([]*RoleAssignment, len(rhs))
		for k, v := range rhs {
			r.Permissions[k] = v.CloneVT()
		}
	}
	if len(m.unknownFields) > 0 {
		r.unknownFields = slices.Clone(m.unknownFields)
...
func (m *UserPermissionList) CloneVT() *UserPermissionList {
	...
	if rhs := m.Items; rhs != nil {
		r.Items = make([]*UserPermission, len(rhs))
		for k, v := range rhs {
			r.Items[k] = v.CloneVT()
		}
	}
...
func (m *ServiceUserPermissionList) CloneVT() *ServiceUserPermissionList {
	...
	if rhs := m.Items; rhs != nil {
		r.Items = make([]*ServiceUserPermission, len(rhs))
		for k, v := range rhs {
			r.Items[k] = v.CloneVT()
		}
	}
...
func (m *PRPEffectivePolicySpec) CloneVT() *PRPEffectivePolicySpec {
	...
	if rhs := m.RequiredPermissions; rhs != nil {
		r.RequiredPermissions = slices.Clone(rhs)
	}
	if len(m.unknownFields) > 0 {
		r.unknownFields = slices.Clone(m.unknownFields)
	}
...
func (m *PRPEffectivePolicySpec) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			m.SourceVersion = 0
			m.SourceVersion, iNdEx, err = protobuf_go_lite.DecodeVarint(dAtA, iNdEx)
			if err != nil {
				return err
			}
		default:
