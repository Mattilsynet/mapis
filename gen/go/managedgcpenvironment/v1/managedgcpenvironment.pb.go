...
type ManagedGcpEnvironmentSpec struct {
	...
	// eg., "123213213", which is the overall namespace name, i.e., map-ops-dev
	NamespaceRef string `protobuf:"bytes,40,opt,name=namespace_ref,json=namespaceRef,proto3" json:"namespace_ref,omitempty"`
...
func (x *ManagedGcpEnvironmentSpec) GetNamespaceRef() string {
	if x != nil {
...
var file_managedgcpenvironment_v1_managedgcpenvironment_proto_rawDesc = []byte{
	...
	0x74, 0x75, 0x73, 0x22, 0x86, 0x02, 0x0a, 0x19, 0x4d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x64, 0x47,
	...
	0x74, 0x65, 0x61, 0x6d, 0x41, 0x72, 0x52, 0x65, 0x70, 0x6f, 0x49, 0x64, 0x12, 0x23, 0x0a, 0x0d,
	0x6e, 0x61, 0x6d, 0x65, 0x73, 0x70, 0x61, 0x63, 0x65, 0x5f, 0x72, 0x65, 0x66, 0x18, 0x28, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x0c, 0x6e, 0x61, 0x6d, 0x65, 0x73, 0x70, 0x61, 0x63, 0x65, 0x52, 0x65,
