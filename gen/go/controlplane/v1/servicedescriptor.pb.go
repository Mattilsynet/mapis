...
func (m *ServiceDescriptorSpec) CloneVT() *ServiceDescriptorSpec {
	...
	if rhs := m.ResourceKinds; rhs != nil {
		...
		for k, v := range rhs {
			r.ResourceKinds[k] = v.CloneVT()
		}
	}
	if rhs := m.DeclaredPermissions; rhs != nil {
		r.DeclaredPermissions = make([]*v11.Permission, len(rhs))
		for k, v := range rhs {
			r.DeclaredPermissions[k] = v.CloneVT()
		}
	}
	if rhs := m.BuiltInRoles; rhs != nil {
		r.BuiltInRoles = make([]*v11.Role, len(rhs))
		for k, v := range rhs {
...
func (m *ServiceDescriptorList) CloneVT() *ServiceDescriptorList {
	...
	if rhs := m.Items; rhs != nil {
		r.Items = make([]*ServiceDescriptor, len(rhs))
		for k, v := range rhs {
			r.Items[k] = v.CloneVT()
		}
	}
...
func (x ServiceActivationMode) MarshalProtoJSON(s *json.MarshalState) {
	s.WriteEnum(int32(x), ServiceActivationMode_name)
}
...
func (x ResourceScope) MarshalProtoJSON(s *json.MarshalState) {
	s.WriteEnum(int32(x), ResourceScope_name)
}
...
func (x ReconciliationMode) MarshalProtoJSON(s *json.MarshalState) {
	s.WriteEnum(int32(x), ReconciliationMode_name)
}
...
func (m *ServiceDescriptorSpec) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			...
			var _v uint64
			_v, iNdEx, err = protobuf_go_lite.DecodeVarint(dAtA, iNdEx)
			m.ServiceActivationMode = ServiceActivationMode(_v)
			if err != nil {
				return err
			}
		case 10:
