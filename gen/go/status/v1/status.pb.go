...
const file_status_v1_status_proto_rawDesc = "" +
	"\n" +
	"\x16status/v1/status.proto\x12\tstatus.v1\x1a\x1ccondition/v1/condition.proto\"[\n" +
	"\x06Status\x127\n" +
	"\n" +
	"conditions\x18\x01 \x03(\v2\x17.condition.v1.ConditionR\n" +
	"conditions\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessageB8Z6github.com/Mattilsynet/mapis/gen/go/status/v1;statusv1b\x06proto3"
