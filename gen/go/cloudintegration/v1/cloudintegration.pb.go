...
func (m *CloudIntegrationList) CloneVT() *CloudIntegrationList {
	...
	if rhs := m.Items; rhs != nil {
		r.Items = make([]*CloudIntegration, len(rhs))
		for k, v := range rhs {
			r.Items[k] = v.CloneVT()
		}
	}
...
func (x ScopeType) MarshalProtoJSON(s *json.MarshalState) {
	s.WriteEnum(int32(x), ScopeType_name)
}
...
func (x AuthMode) MarshalProtoJSON(s *json.MarshalState) {
	s.WriteEnum(int32(x), AuthMode_name)
}
...
func (x CredentialSource) MarshalProtoJSON(s *json.MarshalState) {
	s.WriteEnum(int32(x), CredentialSource_name)
}
...
func (m *Auth) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			var _v uint64
			_v, iNdEx, err = protobuf_go_lite.DecodeVarint(dAtA, iNdEx)
			m.CredentialSource = CredentialSource(_v)
			if err != nil {
				return err
			}
		case 3:
