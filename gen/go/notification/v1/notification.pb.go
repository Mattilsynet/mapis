...
const file_notification_v1_notification_proto_rawDesc = "" +
	"\n" +
	"\"notification/v1/notification.proto\x12\x0fnotification.v1\x1a\x12meta/v1/meta.proto\x1a\x1cgoogle/protobuf/struct.proto\"\x9d\x01\n" +
	"\fNotification\x12%\n" +
	"\x04type\x18\x01 \x01(\v2\x11.meta.v1.TypeMetaR\x04type\x12/\n" +
	"\bmetadata\x18\x02 \x01(\v2\x13.meta.v1.ObjectMetaR\bmetadata\x125\n" +
	"\x04spec\x18\x03 \x01(\v2!.notification.v1.NotificationSpecR\x04spec\"\xce\x03\n" +
	"\x10NotificationSpec\x12I\n" +
	"\toperation\x18\x01 \x01(\x0e2+.notification.v1.NotificationSpec.OperationR\toperation\x12\x1b\n" +
	"\tself_link\x18\x02 \x01(\tR\bselfLink\x12\x1f\n" +
	"\vresource_id\x18\x03 \x01(\tR\n" +
	"resourceId\x12#\n" +
	"\rresource_type\x18\x04 \x01(\tR\fresourceType\x12)\n" +
	"\x10resource_version\x18\x05 \x01(\tR\x0fresourceVersion\x12<\n" +
	"\rresource_data\x18\x06 \x01(\v2\x17.google.protobuf.StructR\fresourceData\x12%\n" +
	...
	"\x10OPERATION_DELETE\x10\x04BDZBgithub.com/Mattilsynet/mapis/gen/go/notification/v1;notificationv1b\x06proto3"
