...
const file_mapspace_v1_mapspace_proto_rawDesc = "" +
	"\n" +
	"\x1amapspace/v1/mapspace.proto\x12\vmapspace.v1\x1a\x1bbuf/validate/validate.proto\x1a\x12meta/v1/meta.proto\x1a\x16status/v1/status.proto\"\x91\x01\n" +
	"\bMapspace\x12%\n" +
	"\x04type\x18\x01 \x01(\v2\x11.meta.v1.TypeMetaR\x04type\x12/\n" +
	"\bmetadata\x18\n" +
	" \x01(\v2\x13.meta.v1.ObjectMetaR\bmetadata\x12-\n" +
	"\x04spec\x18\x14 \x01(\v2\x19.mapspace.v1.MapspaceSpecR\x04spec\"T\n" +
	"\fMapspaceSpec\x12D\n" +
	"\x0fmapspace_status\x18\x14 \x01(\v2\x1b.mapspace.v1.MapspaceStatusR\x0emapspaceStatus\"\x98\x01\n" +
	"\x0eMapspaceStatus\x12H\n" +
	"\tstatusMap\x18\x01 \x03(\v2*.mapspace.v1.MapspaceStatus.StatusMapEntryR\tstatusMap\x1a<\n" +
	"\x0eStatusMapEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01B7Z5github.com/mattilsynet/mapis/gen/mapspace/v1;mapspaceb\x06proto3"

var (
	file_mapspace_v1_mapspace_proto_rawDescOnce sync.Once
	file_mapspace_v1_mapspace_proto_rawDescData []byte
)

func file_mapspace_v1_mapspace_proto_rawDescGZIP() []byte {
	file_mapspace_v1_mapspace_proto_rawDescOnce.Do(func() {
		file_mapspace_v1_mapspace_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_mapspace_v1_mapspace_proto_rawDesc), len(file_mapspace_v1_mapspace_proto_rawDesc)))
	})
...
func file_mapspace_v1_mapspace_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_mapspace_v1_mapspace_proto_rawDesc), len(file_mapspace_v1_mapspace_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
