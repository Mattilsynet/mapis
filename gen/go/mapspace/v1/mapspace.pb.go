...
var file_mapspace_v1_mapspace_proto_goTypes = []interface{}{
...
func file_mapspace_v1_mapspace_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_mapspace_v1_mapspace_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Mapspace); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_mapspace_v1_mapspace_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MapspaceSpec); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_mapspace_v1_mapspace_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MapspaceStatus); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
